...
def empirical_covariance(X, *,aweights =None, assume_centered=False):
    ...
    if assume_centered:
        ...
        covariance = np.cov(X.T, aweights= aweights, bias=1)
...
class EmpiricalCovariance(BaseEstimator):
    ...
    def __init__(self, *, aweights = None, store_precision=True, assume_centered=False):
    ...
    def fit(self, X, y=None):
        ...
        covariance = empirical_covariance(X, aweights=self.aweights, assume_centered=self.assume_centered)
